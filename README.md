...
| **MAEST**                    | Music Audio Efficient Spectrogram Transformer: ViT-based model for music analysis (Discogs pretrained).     | [arXiv:2309.16418](https://arxiv.org/abs/2309.16418)           | [GitHub palonso/MAEST](https://github.com/palonso/MAEST)       |
...
| **Music Flamingo**           | Large audio-language model for music understanding (AF-Whisper encoder; built on Audio Flamingo 3).          | [arXiv:2511.10289](https://arxiv.org/abs/2511.10289)          | [GitHub NVIDIA/audio-flamingo](https://github.com/NVIDIA/audio-flamingo) (branch `music_flamingo`) |
