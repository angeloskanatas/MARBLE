set -e
CONFIG=configs/probe.MAEST.MTT.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/maest-10s-discogs-pw_mtt
OUT=./output/probe.MTT.maest-10s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-10s-discogs-pw_mtt/train")
