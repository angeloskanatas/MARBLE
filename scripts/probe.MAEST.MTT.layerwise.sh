...
EMB_ROOT=./output/extracted_embeddings_probing/lejepa-maest-10s_mtt
OUT=./output/probe.MTT.lejepa-maest-10s.layerwise
...
root = Path("./output/extracted_embeddings_probing/lejepa-maest-10s_mtt/train")
