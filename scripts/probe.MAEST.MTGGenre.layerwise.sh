...
EMB_ROOT=./output/extracted_embeddings_probing/maest-30s-discogs-pw_mtg_genre
OUT=./output/probe.MTGGenre.maest-30s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-30s-discogs-pw_mtg_genre/train")
