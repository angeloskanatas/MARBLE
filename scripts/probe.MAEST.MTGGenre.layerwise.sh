set -e
CONFIG=configs/probe.MAEST.MTGGenre.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/maest-10s-discogs-pw_mtg_genre
OUT=./output/probe.MTGGenre.maest-10s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-10s-discogs-pw_mtg_genre/train")
