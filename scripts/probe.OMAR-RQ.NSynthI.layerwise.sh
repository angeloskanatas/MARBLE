set -e
CONFIG=configs/probe.OMAR-RQ.NSynthI.layerwise.yaml
OUT=./output/probe.NSynthI.omar-rq-multifeature-25hz-fsq.layerwise
NUM_LAYERS=24  # OMAR-RQ has 24 layers (0..23)
