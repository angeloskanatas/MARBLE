set -e
CONFIG=configs/probe.CLAP.NSynthI.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/clap_nsynth
OUT=./output/probe.NSynthI.clap.layerwise
...
root = Path("./output/extracted_embeddings_probing/clap_nsynth/train")
