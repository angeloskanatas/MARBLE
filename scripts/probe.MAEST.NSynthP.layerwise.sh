set -e
CONFIG=configs/probe.MAEST.NSynthP.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/maest-10s-discogs-pw_nsynth
OUT=./output/probe.NSynthP.maest-10s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-10s-discogs-pw_nsynth/train")
