...
EMB_ROOT=./output/extracted_embeddings_probing/maest-30s-discogs-pw_mtg_top50
OUT=./output/probe.MTGTop50.maest-30s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-30s-discogs-pw_mtg_top50/train")
