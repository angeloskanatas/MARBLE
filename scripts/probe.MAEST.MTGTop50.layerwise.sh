set -e
CONFIG=configs/probe.MAEST.MTGTop50.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/maest-10s-discogs-pw_mtg_top50
OUT=./output/probe.MTGTop50.maest-10s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-10s-discogs-pw_mtg_top50/train")
