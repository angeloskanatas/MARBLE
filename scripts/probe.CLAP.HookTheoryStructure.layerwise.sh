set -e
CONFIG=configs/probe.CLAP.HookTheoryStructure.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/clap_hooktheory_structure
OUT=./output/probe.HookTheoryStructure.clap.layerwise
...
root = Path("./output/extracted_embeddings_probing/clap_hooktheory_structure/train")
