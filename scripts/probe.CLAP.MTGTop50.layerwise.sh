set -e
CONFIG=configs/probe.CLAP.MTGTop50.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/clap_mtg_top50
OUT=./output/probe.MTGTop50.clap.layerwise
...
root = Path("./output/extracted_embeddings_probing/clap_mtg_top50/train")
