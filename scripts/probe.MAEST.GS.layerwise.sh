set -e
CONFIG=configs/probe.MAEST.GS.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/maest-10s-discogs-pw_gs
OUT=./output/probe.GS.maest-10s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-10s-discogs-pw_gs/train")
