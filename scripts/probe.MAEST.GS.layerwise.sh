...
EMB_ROOT=./output/extracted_embeddings_probing/maest-30s-discogs-pw_gs
OUT=./output/probe.GS.maest-30s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-30s-discogs-pw_gs/train")
