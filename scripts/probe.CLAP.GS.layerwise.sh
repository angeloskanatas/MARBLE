set -e
CONFIG=configs/probe.CLAP.GS.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/clap_gs
OUT=./output/probe.GS.clap.layerwise
...
root = Path("./output/extracted_embeddings_probing/clap_gs/train")
