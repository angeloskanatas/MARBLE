set -e
CONFIG=configs/probe.MusicFlamingo.NSynthP.layerwise.yaml
OUT=./output/probe.NSynthP.music-flamingo.layerwise
NUM_LAYERS=32  # MusicFlamingo has 32 layers (0..31)
