set -e
CONFIG=configs/probe.CLAP.GTZANGenre.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/clap_gtzan_genre
OUT=./output/probe.GTZANGenre.clap.layerwise
...
root = Path("./output/extracted_embeddings_probing/clap_gtzan_genre/train")
