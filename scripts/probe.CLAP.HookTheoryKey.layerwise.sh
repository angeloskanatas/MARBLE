set -e
CONFIG=configs/probe.CLAP.HookTheoryKey.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/clap_hooktheory_key
OUT=./output/probe.HookTheoryKey.clap.layerwise
...
root = Path("./output/extracted_embeddings_probing/clap_hooktheory_key/train")
