set -e
CONFIG=configs/probe.CLAP.EMO.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/clap_emo
OUT=./output/probe.EMO.clap.layerwise
...
root = Path("./output/extracted_embeddings_probing/clap_emo/train")
