...
EMB_ROOT=./output/extracted_embeddings_probing/maest-30s-discogs-pw_mtg_mood
OUT=./output/probe.MTGMood.maest-30s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-30s-discogs-pw_mtg_mood/train")
