set -e
CONFIG=configs/probe.MAEST.MTGMood.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/maest-10s-discogs-pw_mtg_mood
OUT=./output/probe.MTGMood.maest-10s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-10s-discogs-pw_mtg_mood/train")
