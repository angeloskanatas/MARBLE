set -e
CONFIG=configs/probe.CLAP.MTGMood.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/clap_mtg_mood
OUT=./output/probe.MTGMood.clap.layerwise
...
root = Path("./output/extracted_embeddings_probing/clap_mtg_mood/train")
