set -e
CONFIG=configs/probe.CLAP.MTGInstrument.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/clap_mtg_instrument
OUT=./output/probe.MTGInstrument.clap.layerwise
...
root = Path("./output/extracted_embeddings_probing/clap_mtg_instrument/train")
