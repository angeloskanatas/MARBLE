...
EMB_ROOT=./output/extracted_embeddings_probing/maest-30s-discogs-pw_hooktheory_structure
OUT=./output/probe.HookTheoryStructure.maest-30s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-30s-discogs-pw_hooktheory_structure/train")
