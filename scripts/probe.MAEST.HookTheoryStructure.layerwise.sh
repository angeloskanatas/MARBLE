set -e
CONFIG=configs/probe.MAEST.HookTheoryStructure.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/maest-10s-discogs-pw_hooktheory_structure
OUT=./output/probe.HookTheoryStructure.maest-10s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-10s-discogs-pw_hooktheory_structure/train")
