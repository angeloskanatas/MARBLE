...
EMB_ROOT=./output/extracted_embeddings_probing/maest-30s-discogs-pw_emo
OUT=./output/probe.EMO.maest-30s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-30s-discogs-pw_emo/train")
