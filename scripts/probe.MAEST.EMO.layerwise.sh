...
EMB_ROOT=./output/extracted_embeddings_probing/maest_emo
OUT=./output/probe.EMO.maest.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest_emo/train")
