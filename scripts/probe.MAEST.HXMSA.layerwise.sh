set -e
CONFIG=configs/probe.MAEST.HXMSA.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/maest-10s-discogs-pw_hxmsa
OUT=./output/probe.HXMSA.maest-10s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-10s-discogs-pw_hxmsa/train")
