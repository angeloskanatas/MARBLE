set -e
CONFIG=configs/probe.MAEST.MTGInstrument.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/maest-30s-discogs-pw_mtg_instrument
OUT=./output/probe.MTGInstrument.maest-30s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-30s-discogs-pw_mtg_instrument/train")
