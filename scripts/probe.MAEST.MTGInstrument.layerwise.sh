...
EMB_ROOT=./output/extracted_embeddings_probing/maest-10s-discogs-pw_mtg_instrument
OUT=./output/probe.MTGInstrument.maest-10s-discogs-pw.layerwise
...
root = Path("./output/extracted_embeddings_probing/maest-10s-discogs-pw_mtg_instrument/train")
