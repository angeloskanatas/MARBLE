set -e
CONFIG=configs/probe.CLAP.MTT.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/clap_mtt
OUT=./output/probe.MTT.clap.layerwise
...
root = Path("./output/extracted_embeddings_probing/clap_mtt/train")
