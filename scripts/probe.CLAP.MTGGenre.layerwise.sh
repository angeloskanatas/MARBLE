set -e
CONFIG=configs/probe.CLAP.MTGGenre.layerwise.yaml
EMB_ROOT=./output/extracted_embeddings_probing/clap_mtg_genre
OUT=./output/probe.MTGGenre.clap.layerwise
...
root = Path("./output/extracted_embeddings_probing/clap_mtg_genre/train")
