# marble/tasks/MTGMood/embedding_dataset.py
...
from marble.tasks.MTGMood.datamodule import _MTGMoodAudioBase


class MTGMoodEmbeddingDataset(Dataset):
    """
    ...
    LABEL2IDX = _MTGMoodAudioBase.LABEL2IDX
...
class MTGMoodMultiLayerEmbeddingDataset(Dataset):
    """
