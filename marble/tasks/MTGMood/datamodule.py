...
class MTGMoodMultiLayerEmbeddingDataModule(pl.LightningDataModule):
    """
    DataModule for probing on pre-extracted MTGMood embeddings with MULTIPLE layers.
    ...
    def __init__(
        ...
        super().__init__()
        from marble.tasks.MTGMood.embedding_dataset import MTGMoodMultiLayerEmbeddingDataset
        self._dataset_cls = MTGMoodMultiLayerEmbeddingDataset
