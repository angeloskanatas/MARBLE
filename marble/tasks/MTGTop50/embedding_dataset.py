# marble/tasks/MTGTop50/embedding_dataset.py
...
class MTGTop50EmbeddingDataset(Dataset):
    """
    ...
    LABEL2IDX = _MTGTop50AudioBase.LABEL2IDX
...
class MTGTop50MultiLayerEmbeddingDataset(Dataset):
    """
