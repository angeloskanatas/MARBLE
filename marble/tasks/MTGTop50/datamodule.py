...
class MTGTop50MultiLayerEmbeddingDataModule(pl.LightningDataModule):
    """
    DataModule for probing on pre-extracted MTGTop50 embeddings with MULTIPLE layers.
    ...
    def __init__(
        ...
        super().__init__()
        from marble.tasks.MTGTop50.embedding_dataset import MTGTop50MultiLayerEmbeddingDataset
        self._dataset_cls = MTGTop50MultiLayerEmbeddingDataset
