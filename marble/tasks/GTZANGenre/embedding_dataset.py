# marble/tasks/GTZANGenre/embedding_dataset.py
...
class GTZANGenreEmbeddingDataset(Dataset):
    """
    ...
    def __init__(
        ...
        self._path_to_label = {
            info["audio_path"]: LABEL2IDX[info["label"]]
...
class GTZANGenreMultiLayerEmbeddingDataset(Dataset):
    """
