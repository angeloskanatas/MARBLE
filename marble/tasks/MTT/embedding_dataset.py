# marble/tasks/MTT/embedding_dataset.py
...
from marble.tasks.MTT.datamodule import _MTTAudioBase
...
class MTTEmbeddingDataset(Dataset):
    ...
    LABEL2IDX = _MTTAudioBase.LABEL2IDX
...
class MTTMultiLayerEmbeddingDataset(Dataset):
    """
