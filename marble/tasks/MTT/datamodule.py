...
class MTTMultiLayerEmbeddingDataModule(pl.LightningDataModule):
    """
    DataModule for probing on pre-extracted MTT embeddings with MULTIPLE layers.
    ...
    def __init__(
        ...
        super().__init__()
        from marble.tasks.MTT.embedding_dataset import MTTMultiLayerEmbeddingDataset
        self._dataset_cls = MTTMultiLayerEmbeddingDataset
