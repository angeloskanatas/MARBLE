# marble/tasks/MTGInstrument/embedding_dataset.py
...
from marble.tasks.MTGInstrument.datamodule import _MTGInstrumentAudioBase


class MTGInstrumentEmbeddingDataset(Dataset):
    """
    ...
    LABEL2IDX = _MTGInstrumentAudioBase.LABEL2IDX
...
class MTGInstrumentMultiLayerEmbeddingDataset(Dataset):
    """
